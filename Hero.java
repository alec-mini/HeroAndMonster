...
public class Hero {
    ...
    int gear;
    String name;
    public Hero(int h, int p, int g, String n) {
        health = h;
        power = p;
        gear = g;
        name = n;
    ...
    public int attack() {
        System.out.println(name + " has just attacked the monster with the power of " + power + " and the effective power of " + (gear * power));
        return power * gear;
    }
    public int mega() {
        gear--;
